          ...
          <div class="card-body">
            ...
            <div class="row align-items-center pt-3 pb-2">
              ...
              <div class="col-md-9 pe-5">
                ...
                <input type="text" name="name" id="name" value="{{$restaurants->name}}" placeholder="Name" class="form-control form-control-sm" />
                ...
                <div class="row align-items-center pt-3 pb-2">
                    ...
                    <img src="{{$restaurants->banner}}" width="200px" hight="100px" alt=""> 
                  </div>
                    ...
                    <div class="col-md-3 ps-5">
                      ...
                      <option value="{{$restaurants->cuisine->id}}">{{$restaurants->cuisine->cuisine}}</option>

                      @foreach($cuisines as $cuisine)
                        @if($cuisine->cuisine != $restaurants->cuisine->cuisine)
